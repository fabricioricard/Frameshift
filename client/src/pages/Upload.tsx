...
import { Upload as UploadIcon, ArrowLeft, Radio } from "lucide-react";
...
export default function Upload() {
  ...
  const handleCreateStream = () => {
    ...
    if (!streamUrl.trim()) {
      toast.error("URL da transmissão é obrigatória");
      return;
    }
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="video">
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Enviar Vídeo</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-2">
                    Forneça uma URL pública para seu vídeo (MP4, WebM, etc.)
                  </p>
                </div>
          ...
          <TabsContent value="stream">
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Criar Transmissão ao Vivo</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">
                  ...
                  <Input
                    placeholder="Título da sua transmissão"
                    value={streamTitle}
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">
                    URL da Transmissão (RTMP/HLS) *
                  </label>
                  <Input
                    placeholder="rtmp://exemplo.com/live/stream"
                    value={streamUrl}
                  ...
                  />
                  <p className="text-xs text-slate-400 mt-2">
                    Forneça uma URL RTMP ou HLS para sua transmissão ao vivo
                  </p>
                </div>
