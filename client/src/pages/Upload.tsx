            ...
            <Card className="bg-slate-800 border-slate-700">
              ...
              <CardContent className="space-y-4">
                ...
                {uploading && (
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm text-slate-400">
                      <span>
                        {uploadProgress < 100 ? "Enviando para IPFS..." : "Publicando..."}
                      </span>
                    ...
                    <p className="text-xs text-slate-500">
                      O vídeo está sendo publicado na rede IPFS de forma descentralizada.
                    </p>
                  </div>
                )}
                ...
                <Button
                  ...
                  className="w-full gap-2 bg-red-500 hover:bg-red-600 text-white disabled:opacity-50"
                >
                  <UploadIcon className="w-4 h-4" />
          ...
          <TabsContent value="stream">
            <Card className="bg-slate-800 border-slate-700">
              ...
              <CardContent className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">Título *</label>
                  <Input placeholder="Título da transmissão" value={streamTitle} onChange={(e) => setStreamTitle(e.target.value)} className="bg-slate-700 border-slate-600 text-white" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">Descrição</label>
