        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="aspect-video bg-black rounded-lg overflow-hidden mb-6 relative">
              {stream.streamUrl ? (
                <iframe src={stream.streamUrl} className="w-full h-full" allowFullScreen allow="autoplay" />
              ) : (
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-slate-400 text-sm mt-2">{stream.viewers} espectadores</p>
                  </div>
              ...
              <CardContent>
                {stream.description && <p className="text-slate-300">{stream.description}</p>}
              </CardContent>
            </Card>
          </div>
          ...
          <div className="lg:col-span-1">
            <Card className="bg-slate-800 border-slate-700">
              ...
              <CardContent className="text-slate-300 text-sm space-y-2">
                ...
                <p>Iniciado em: {stream.startedAt ? new Date(stream.startedAt).toLocaleString("pt-BR") : "Não iniciado"}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800 border-slate-700 mt-4">
              ...
              <CardContent>
                <div className="bg-slate-700 rounded p-4 h-64 flex items-center justify-center">
                  <p className="text-slate-400 text-center">Chat em tempo real em breve</p>
                </div>
              </CardContent>
            </Card>
          </div>
